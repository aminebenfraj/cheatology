      ...
      >
        ...
        >
          ...
          <div className="flex gap-2 text-sm">
            ...
            At Cheatology, we thrive on building your projects from the ground up. We ensure that your assignment is tailored to your specifications.
        ...
        >
          ...
          <div className="flex gap-2 text-sm">
            <p className="text-zinc-500 text-sm text-center">
            We provide ongoing maintenance and adaptability to your projects. We listen to your feedback and make necessary modifications and improvements.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex gap-2 text-sm">
            <p className="text-zinc-500 text-sm text-center">
            For a small extra fee, we provide detailed explanations of your project's code, guiding you through each line for a deeper understanding.
            </p>
          </div>
        </div>
      </div>
