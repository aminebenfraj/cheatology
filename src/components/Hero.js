      ...
      <div className="w-full flex flex-col items-center px-4 py-8 mx-auto text-center md:px-10 lg:px-32 xl:max-w-3xl">
        ...
        <div className="flex flex-wrap justify-center items-center gap-5">
          <div className="w-fit h-fit rounded-md bg-primary overflow-visible">
            <button className="px-8 py-3 border border-primary hover:border-l-white hover:border-b-white rounded bg-primary text-white hover:translate-x-1 hover:-translate-y-1 transition-all">
              Contact us
            </button>
          </div>
